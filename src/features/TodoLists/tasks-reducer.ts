...
export const removeTask = createAsyncThunk('tasks/removeTask', (param:{todoListId: string, taskId: string}, thunkAPI) => {
...
export const removeTask_ = (todoListId: string, taskId: string) => (dispatch: Dispatch) => {
